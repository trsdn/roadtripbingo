...
let isNavigating = false; // Flag to prevent hash change loops
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        // Icon Manager is now a dedicated page - no hash routing needed
        console.log('Icon Manager runs as dedicated page at /iconmanager');
...
function setupEventListeners() {
    ...
    // Icon Manager is now a dedicated page at /iconmanager
    if (navIconManagerBtn) {
        console.log('✅ Icon Manager link found - now links to dedicated page');
    } else {
        console.log('ℹ️ Icon Manager link not found (expected for dedicated page)');
    }
...
function switchToPage(page) {
    ...
    if (page === 'iconManager') {
        window.location.hash = 'iconmanager';
    } else {
